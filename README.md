...
- Optional local-only Memory injects relevant English/Chinese cross-session facts into future turns as untrusted context, respects explicit memory opt-out phrases, and exposes `/memory` tools with Unicode/CJK-aware search
